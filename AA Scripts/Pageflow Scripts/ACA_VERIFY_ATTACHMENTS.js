/*------------------------------------------------------------------------------------------------------/
| Program : ACA_VERIFY_ATTACHMENTS.js
| Event   : -
|
| Usage   : .
|
...
|
|	4. Attach (ACA_SHOW_ATTACHMENTS) to the onLoad event of the pageflow
|
|	5. Attach this script (ACA_VERIFY_ATTACHMENTS) script to the beforeButton event of the pageflow
|
/------------------------------------------------------------------------------------------------------*/
